...
###############################################################
	...
	#	self.change_msg()
		...
		canvas1.create_rectangle(0,0,CANVAS_WIDTH,CANVAS_HEIGHT,fill=color)
		canvas1.create_text(TXT_W,TXT_H,font=(u'ＭＳ ゴシック',TXT_SIZE),text="1")

		canvas2.create_rectangle(0,0,CANVAS_WIDTH,CANVAS_HEIGHT,fill=color)
		canvas2.create_text(TXT_W,TXT_H,font=(u'ＭＳ ゴシック',TXT_SIZE),text="2")

		canvas3.create_rectangle(0,0,CANVAS_WIDTH,CANVAS_HEIGHT,fill=color)
		canvas3.create_text(TXT_W,TXT_H,font=(u'ＭＳ ゴシック',TXT_SIZE),text="3")

		canvas4.create_rectangle(0,0,CANVAS_WIDTH,CANVAS_HEIGHT,fill=color)
